...
// Class definition
let KTEmployeesDatatable = function () {
    ...
    let initDatatable = function () {
        datatable = $("#kt_employees_datatable").DataTable({
            orderable: false,
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ...
            ajax: {
                data: function () {
                    let datatable = $('#kt_employees_datatable');
                    let info = datatable.DataTable().page.info();
                    datatable.DataTable().ajax.url(`/dashboard/employees?page=${info.page + 1}&per_page=${info.length}` + companyIdFilter );
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                {
                    targets: 1,
                    orderable: false,
                    render: (data, type, row) => row.first_name + ' ' + row.last_name
                },
                {
                    targets: -1,
                    data: null,
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/employees/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/employees/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
