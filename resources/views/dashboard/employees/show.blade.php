                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                        ...
                        <input class="form-check-input mx-2" style="height: 18px;width:36px;"
                               type="checkbox" name="status" id="status-switch" {{ $employee->status ? 'checked' : '' }} disabled />
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" disabled value="{{ $employee['phone'] }}" />
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" disabled  value="{{ $employee['occupation'] }}" />
