...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.companies.index') }}" class="text-muted text-hover-primary">{{ __("Companies") }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.companies.store') }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.companies.index') }}">
            @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("add new company") }}</h3>
                    <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                        <label class="fs-5 fw-bold">{{ __("Status") }}</label>
                        <input class="form-check-input mx-2" style="height: 18px;width:36px;"
                               type="checkbox" name="status" id="status-switch" checked  />
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="card-body text-center mt-2">
                        <!--begin::Image input-->
                        <x-dashboard.upload-image-inp name="logo" :image="null" directory="Companies" placeholder="default.jpg" type="editable"></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="website_inp" name="website" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" class="form-control" id="revenue_inp" name="revenue" placeholder="example"/>
